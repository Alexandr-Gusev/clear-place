...
const Manifest = ({count, setCookie, onExit}) => (
  <div className={styles.manifest} ref={element => element && element.scrollIntoView(true)}>
    ...
    <div className={styles.manifestText}>
      Соседи, для достойной жизни всем нам требуется инфраструктура - бытовая и ливневая канализация, дороги и тротуары. К сожалению ничего этого у нас нет. И это не смотря на то, что стоимость этой инфраструктуры неявно входила в стоимость приобретенных нами у города участков. Не смотря на то, что, уплачивая земельный налог, мы уже почти два раза оплатили постройку этой инфраструктуры. К сожалению, все эти средства были потрачены городом на другие цели. У города нет возможности выполнить свои обязательства здесь и сейчас. Более того, город даже не планирует выполнение своих обязательств в обозримом будущем. Пора перестать обманывать себя. Никто кроме нас не будет строить необходимые нам объекты. Если мы хотим изменить ситуацию, то надо взять дело в свои руки. Однако, объем и стоимость работ несоизмеримы с возможностями одного хозяйства. Построить инфраструктуру можно только всем вместе. Мы все нуждаемся друг в друге. Если ваши соседи не проведут вдоль своих участков коммуникации, то вы просто не сможете заплатить за "крыс" и коммуникации просто не дойдут до вас. Остаться в стороне вы сможете только потеряв уважение к самому себе и продолжив жить в грязи посреди современного города.
      <h2>Предлагается</h2>
      <ul>
      ...
      <ul>
        ...
        <li>Всего на одно хозяйство: 355 000 ₽</li>
        <li>Всего на всю территорию: 142 000 000 ₽</li>
      </ul>
